...
class PredictionForm(forms.Form):
    Visit = forms.IntegerField(label="Visit")
    MR_Delay = forms.IntegerField(label="MR Delay")
    M_F = forms.ChoiceField(label="Gender", choices=[('M', 'Male'), ('F', 'Female')])
    Age = forms.FloatField()
    EDUC = forms.FloatField(label="Education")
